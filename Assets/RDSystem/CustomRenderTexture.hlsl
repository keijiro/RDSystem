// Unity Custom Render Texture support for Core SRP
// Converted from Unity built-in UnityCustomRenderTexture.cginc

#ifndef UNITY_CUSTOM_RENDER_TEXTURE_HLSL
#define UNITY_CUSTOM_RENDER_TEXTURE_HLSL
...
// Texture declarations using Core SRP macros
...
v2f_customrendertexture CustomRenderTextureVertexShader(appdata_customrendertexture IN)
{
    ...
    if (CustomRenderTextureIs3D > 0.0)
    {
        ...
        {
            pos.xy = float2(1000.0, 1000.0); // Vertex outside of ndc
        }
    }
...
#endif // UNITY_CUSTOM_RENDER_TEXTURE_HLSL